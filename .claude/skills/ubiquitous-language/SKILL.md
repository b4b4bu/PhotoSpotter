...
description: Extract and formalize domain terminology from the current conversation into a consistent glossary, saved to UBIQUITOUS_LANGUAGE.md. Use when user wants to establish shared vocabulary, create a domain glossary, or standardize terminology.
---
